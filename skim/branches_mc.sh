...
-d "softssvhe" \
-d "softtche" \
-d "std_vector_VBoson_eta" \
-d "std_vector_VBoson_mass" \
-d "std_vector_VBoson_phi" \
-d "std_vector_VBoson_pid" \
-d "std_vector_VBoson_pt" \
-d "std_vector_dressedLeptonGen_eta" \
-d "std_vector_dressedLeptonGen_phi" \
-d "std_vector_dressedLeptonGen_pid" \
-d "std_vector_dressedLeptonGen_pt" \
-d "std_vector_jetGen_eta" \
-d "std_vector_jetGen_phi" \
-d "std_vector_jetGen_pt" \
-d "std_vector_leptonGen_MotherPID" \
-d "std_vector_leptonGen_MotherStatus" \
-d "std_vector_leptonGen_eta" \
-d "std_vector_leptonGen_fromHardProcess" \
-d "std_vector_leptonGen_isDirectHadronDecayProduct" \
-d "std_vector_leptonGen_isDirectPromptTauDecayProduct" \
-d "std_vector_leptonGen_isPrompt" \
-d "std_vector_leptonGen_isTauDecayProduct" \
-d "std_vector_leptonGen_phi" \
-d "std_vector_leptonGen_pid" \
-d "std_vector_leptonGen_pt" \
-d "std_vector_leptonGen_status" \
-d "std_vector_neutrinoGen_MotherPID" \
-d "std_vector_neutrinoGen_MotherStatus" \
-d "std_vector_neutrinoGen_eta" \
-d "std_vector_neutrinoGen_isDirectPromptTauDecayProduct" \
-d "std_vector_neutrinoGen_isPrompt" \
-d "std_vector_neutrinoGen_phi" \
-d "std_vector_neutrinoGen_pid" \
-d "std_vector_neutrinoGen_pt" \
-d "std_vector_partonGen_eta" \
-d "std_vector_partonGen_isHardProcess" \
-d "std_vector_partonGen_isPrompt" \
-d "std_vector_partonGen_phi" \
-d "std_vector_partonGen_pid" \
-d "std_vector_partonGen_pt" \
-d "std_vector_photonGen_MotherPID" \
-d "std_vector_photonGen_MotherStatus" \
-d "std_vector_photonGen_eta" \
-d "std_vector_photonGen_phi" \
-d "std_vector_photonGen_pt" \
...
-d "bPogSF_CMVAM" \
-d "bPogSF_CMVAM_up" \
-d "bPogSF_CMVAM_udsg_up" \
-d "bPogSF_CMVAM_bc_up" \
-d "bPogSF_CMVAM_down" \
-d "bPogSF_CMVAM_udsg_down" \
-d "bPogSF_CMVAM_bc_down" \
-d "bPogSF_CMVAT" \
-d "bPogSF_CMVAT_up" \
-d "bPogSF_CMVAT_udsg_up" \
-d "bPogSF_CMVAT_bc_up" \
-d "bPogSF_CMVAT_down" \
-d "bPogSF_CMVAT_udsg_down" \
-d "bPogSF_CMVAT_bc_down" \
-d "bPogSF_CSVL" \
-d "bPogSF_CSVL_up" \
-d "bPogSF_CSVL_udsg_up" \
-d "bPogSF_CSVL_bc_up" \
-d "bPogSF_CSVL_down" \
-d "bPogSF_CSVL_udsg_down" \
-d "bPogSF_CSVL_bc_down" \
-d "bPogSF_CSVM" \
-d "bPogSF_CSVM_up" \
-d "bPogSF_CSVM_udsg_up" \
-d "bPogSF_CSVM_bc_up" \
-d "bPogSF_CSVM_down" \
-d "bPogSF_CSVM_udsg_down" \
-d "bPogSF_CSVM_bc_down" \
-d "bPogSF_CSVT" \
-d "bPogSF_CSVT_up" \
-d "bPogSF_CSVT_udsg_up" \
-d "bPogSF_CSVT_bc_up" \
-d "bPogSF_CSVT_down" \
-d "bPogSF_CSVT_udsg_down" \
-d "bPogSF_CSVT_bc_down" \
-d "bPogSFUp" \
-d "bPogSFDown" \
-d "effTrigW3l_Up" \
-d "effTrigW_DbleMu" \
...
-d "effTrigW_EleMu" \
-d "effTrigW_SnglMu" \
-d "std_vector_TrgEmulator" \
-d "std_vector_lepton_recoW_Up" \
-d "std_vector_lepton_recoW_Down" \
-d "std_vector_lepton_idisoW_Syst" \
-d "std_vector_lepton_idisoLooseW" \
-d "std_vector_lepton_idisoLooseW_Up" \
-d "std_vector_lepton_idisoLooseW_Down" \
-d "std_vector_lepton_idisoLooseW_Syst" \
-d "pTWW" \
-d "mcoll" \
-d "m2ljj30" \
-d "mcollWW" \
